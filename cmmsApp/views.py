...
def request_demo_view(request):
    ...
    subject = "New Container Solution inquiry"
    text_body = (
        "A new Container Solution inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New Container Solution Inquiry Request</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Container Solution Inquiry"
        text_body = "\n".join(
            [
                "New contact submission for Container Solution Inquiry:",
...
def contact_block_submit(request):
    ...
    text_body = "\n".join([
        "A new consulting request was submitted for Container Solution:",
        f"Name: {name}",
        f"Email: {email}",
